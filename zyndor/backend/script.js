const photoUploadAPI = 'https://script.google.com/macros/s/AKfycbzOTgp9v7RehRIs0ZRQSZsAmn9u9o-cg3byAdm8kf6Gdp3XUpIXHjh0RWkrNmD2X0I6/exec';
...
// https://script.google.com/macros/s/AKfycbw9MXA3T0vC4bg1Rwqz7DY8xRAEQ8EjaQGLjZR6SEE90QoXvEWEfpsinLvJRUPfrGyaug/exec
// https://script.google.com/macros/s/AKfycbzOTgp9v7RehRIs0ZRQSZsAmn9u9o-cg3byAdm8kf6Gdp3XUpIXHjh0RWkrNmD2X0I6/exec
let year = '';
const people = [];
...
document.getElementById('addBtn').onclick = () => {
    ...
    li.innerHTML = `<b>${person.name}</b><br>`;
